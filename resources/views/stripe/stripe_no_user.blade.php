...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 mb-4">
      		 <h1 class="text-center text-primary">Stripe決済テスト(ログインなし)</h1>
        </div>
        <div class="col-12">
    ...
    <form id = "payment_form" method = "post" action = "./stripe_pay_no_user">
    @csrf
	...
	<div class="mt-3 mb-3 px-2">
					...
					<label for="user_mail" class="form-label">メールアドレス</label>
					 <input type="email" class="form-control " id="user_mail" name="user_mail" placeholder="メールアドレス" required>
				</div>
			<div id="card-area">
				<div class="mt-3 mb-3 px-2">
					<h4>お支払いカード情報</h4>
