...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 mb-3">
      		 <h1 class="text-center text-primary">画像変換（黒→指定色）</h1>
        </div>
         <div class="col-12 mb-3">
      		 <form method="post" action="./black_to" class="row" enctype="multipart/form-data">
      		 @csrf
              <div class="col-2 mb-3">
                <label for="color" class="form-label">指定色</label>
                <input type="color" class="form-control" id="color" name="color" required>
              </div>
                 <div class="col-12 mb-3">
                <label for="file" class="form-label">変換元ファイル</label>
